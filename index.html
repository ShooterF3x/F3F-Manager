...
<div id="view-home">
    <div style="position:absolute; top:20px; right:15px; display:flex; gap:10px;">
        ...
        <button class="btn btn-outline" style="width:auto; padding:10px;" onclick="navigateTo('settings')">⚙️</button>
    </div>
    ...
    <div class="row" style="margin-top:20px;"><button class="btn btn-primary" onclick="createNewGlider()" data-i18n="new_model">NOUVEAU MODÈLE</button></div>
...
<div id="view-settings" class="hidden">
    ...
    <div class="card">
        ...
        <div style="margin-bottom:10px; font-size:0.8rem; color:var(--text-muted);" data-i18n="opt_desc">Réglages des limites acceptables pour l'algorithme.</div>
        <div class="row">
        ...
        <div style="margin-bottom:10px; font-size:0.8rem; color:var(--text-muted);" data-i18n="gl_desc"> Définissez la courbe de ballastage. </div>
        
       <div style="background:var(--input); padding:10px; border-radius:var(--radius); border:1px solid var(--border); margin-bottom:10px;">
            <div style="font-weight:bold; color:var(--primary); margin-bottom:5px; font-size:0.9rem;">POINT 1 (Léger/Vide)</div>
            <div class="row">
        ...
        <div id="block-pivot" class="hidden" style="background:rgba(13, 110, 253, 0.1); padding:10px; border-radius:var(--radius); border:1px solid var(--primary); margin-bottom:10px;">
            <div style="font-weight:bold; color:#fff; margin-bottom:5px; font-size:0.9rem;">📍 POINT PIVOT (Intermédiaire)</div>
            <div class="row">
        ...
        <h2 data-i18n="data_title" style="margin-top:20px;">DONNÉES & SAUVEGARDE</h2>
...
<div id="view-calc" class="hidden">
    ...
    <div style="flex:1; margin-right:5px;">
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:2px;">
            <label class="dyno-label" data-i18n="wind" style="margin:0; padding:0; line-height:1.2;">Vent (m/s)</label>
            <span style="font-size:0.75rem; visibility:hidden;">0m</span>
        </div>
        <input type="number" id="inp-wind" step="0.1" min="0" oninput="syncInputs('wind', this.value)">
        <input type="range" id="rng-wind" min="3" max="25" step="0.5" oninput="syncInputs('wind', this.value)">
    </div>

    <div style="flex:1;">
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:2px;">
            <label class="dyno-label" data-i18n="factor" style="margin:0; padding:0; line-height:1.2;">Facteur %</label>
        ...
        <button class="btn btn-magic" onclick="autoFillBallast()" data-i18n="optimize">🪄 OPTIMISER</button>
    </div>
    ...
    <div class="card" style="margin-top:20px;">
        ...
        <button class="btn btn-log" onclick="openSaveLogModal()" data-i18n="save_flight">💾 ENREGISTRER</button>
    </div>
</div>

<div id="view-edit" class="hidden">
    <h2 data-i18n="edit_title">ÉDITION</h2>
    <div class="card">
        ...
        <div style="margin-top:10px;">
             <div class="row">
                 <div style="flex:0 0 50px; display:flex; flex-direction:column; align-items:center;">
                     ...
                     <div onclick="resetColor('nose')" style="font-size:0.8rem; cursor:pointer; color:var(--text-muted); margin-top:4px;">↺</div>
                 </div>
                 <div style="flex:1">
    ...
    <div style="margin-top:20px;">
        ...
        <button class="btn btn-dark" onclick="exportData('model')" data-i18n="export_model">EXPORTER MODÈLE</button>
...
<div id="view-logbook" class="hidden">
    <div class="row header-row">
        <button class="btn btn-outline small-btn" onclick="history.back()" data-i18n="back">⬅ RETOUR</button>
